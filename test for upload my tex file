...
\title{Homework 1 : Class Field Theory} 
\author{Hyojin Kim} 
\date{march 22, 2019} 
\maketitle 
...
In this note, I will follow and summary of chapter 2 of \cite{M} and every notation is same as the book. 
...
The author shows two proofs of \ref{thm2.1} in \cite{M}, and I will sketch of one of them which is Dedekind's. 
...
Followings will show that $\mathcal{O}_K$ is finitely generated as a $\mathbb{Z}$-module. 
...
(b) (Stickelberger's theorem) $disc(\mathcal{O}_K /\mathbb{Z} )\equiv 0$ or $1~mod~4$. 
\end{prop} 
